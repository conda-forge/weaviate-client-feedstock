About weaviate-client-feedstock
===============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/weaviate-client-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/weaviate-client-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add weaviate-client
# for installing globally
pixi global install weaviate-client
```
...
It is possible to list all of the versions of `weaviate-client` available on your platform:
...
```
pixi search weaviate-client --channel conda-forge
```
